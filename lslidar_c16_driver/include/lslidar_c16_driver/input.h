...
#include <ros/ros.h>
#include <lslidar_c16_msgs/LslidarC16MsPacket.h>
#include <lslidar_c16_msgs/LslidarC16DifPacket.h>
#include <string>
#include <sstream>
...
public:
  ...
  virtual int getMsPacket(lslidar_c16_msgs::LslidarC16MsPacket* pkt, const double time_offset) = 0;
  virtual int getDifPacket(lslidar_c16_msgs::LslidarC16DifPacket* pkt, const double time_offset) = 0;
...
public:
  ...
  virtual ~InputSocket();
    ...
    virtual int getMsPacket(lslidar_c16_msgs::LslidarC16MsPacket* pkt, const double time_offset) ;
    virtual int getDifPacket(lslidar_c16_msgs::LslidarC16DifPacket* pkt, const double time_offset) ;
