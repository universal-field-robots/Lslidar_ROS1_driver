...
/** \brief lslidar data conversion class */
    ...
    public:
        ...
        void unpack(const lslidar_c16_msgs::LslidarC16MsPacket &pkt, VPointCloud::Ptr pointcloud,int Packet_num,lslidar_c16_msgs::LslidarC16SweepPtr& sweep_data);

        void processDifop(const lslidar_c16_msgs::LslidarC16DifPacket::ConstPtr &difop_msg);
