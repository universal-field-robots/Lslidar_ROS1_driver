...
namespace lslidar_rawdata {
    ...
    void RawData::loadConfigFile(ros::NodeHandle node, ros::NodeHandle private_nh) {
        ...
        private_nh.param("distance_unit", distance_unit_, float(0.40));
        ...
        private_nh.param("max_range", max_distance_, 200.0f);
    ...
    void RawData::processDifop(const lslidar_c16_msgs::LslidarC16DifPacket::ConstPtr &difop_msg) {
 ...
 */
    void
    RawData::unpack(const lslidar_c16_msgs::LslidarC16MsPacket &pkt, VPointCloud::Ptr pointcloud, int Packet_num,
