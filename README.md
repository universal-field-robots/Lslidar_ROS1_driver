...
# lslidar_MS-CCH32_V1.0

## Description

The `lslidar_MS-CH32_v1.0` package is a linux ROS driver for lslidar MS-CH32_V1.0.
...
cd src<br>
git clone –b MS-CH32_v1.0 https://github.com/lsLIDAR/lslidar_ros/MS-CH32_v1.0<br>
catkin_make<br>
...
Pointcloud2 topic name. Modifiable.

`frequency` (`double`, `default: 10.0`)

Lidar scanning frequency. Default value: 10.0Hz.

`return_model` (`int`, `default: 1`)

Return model. Default value: 1. (1 represents single return mode; 2 represents dual return mode)
