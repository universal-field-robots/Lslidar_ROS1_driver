...
# lslidar_ch128x1_V1.0

## Description

The `lslidar_ch128x1_v1.0` package is a linux ROS driver for lslidar CH128x1_ V1.0.
...
cd src<br>
git clone –b CH128x1_v1.0 https://github.com/lsLIDAR/lslidar_ros/CH128x1_v1.0<br>
catkin_make<br>
...
`max_range` (`double`, `default: 200.0`)

The maximum scanning range. Point cloud data outside this range would be removed. Default value: 200 meters.
...
`channel_num` (`int`, `default: 64`)

The channel number presented when publish_laserscan is opened. Default value: 64.
...
```
roslaunch lslidar_ch128x1_decoder lslidar_ch.launch
```
