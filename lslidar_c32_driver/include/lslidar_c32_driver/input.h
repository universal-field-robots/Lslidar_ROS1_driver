...
public:
  ...
  virtual int getPacket(lslidar_c32_msgs::LslidarC32Packet* pkt, const double time_offset) = 0;
...
public:
  ...
  virtual int getPacket(lslidar_c32_msgs::LslidarC32Packet* pkt, const double time_offset);
