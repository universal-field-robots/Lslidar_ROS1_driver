...
int InputSocket::getPacket(lslidar_c32_msgs::LslidarC32Packet* pkt, const double time_offset)
{
...
/** @brief Get one lslidar packet. */
int InputPCAP::getPacket(lslidar_c32_msgs::LslidarC32Packet* pkt, const double time_offset)
{
