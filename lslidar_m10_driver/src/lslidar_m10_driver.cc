...
bool LslidarM10Driver::createRosIO() {
  ...
  const double diag_freq = 10000.0 / 42;
  ...
  // Output
  packet_pub = nh.advertise<lslidar_m10_msgs::LslidarM10Packet>(
		"lslidar_packet", 100);
		
	//std::string output_difop_topic;
	//pnh.param("output_difop_topic", output_difop_topic, std::string("lslidar_packet_difop"));
	difop_output_ = nh.advertise<lslidar_m10_msgs::LslidarM10Packet>("lslidar_packet_difop", 100);
