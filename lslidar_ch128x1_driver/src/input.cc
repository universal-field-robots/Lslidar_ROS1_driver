...
namespace lslidar_ch_driver {
    static const size_t packet_size = sizeof(lslidar_ch128x1_msgs::LslidarChPacket().data);
////////////////////////////////////////////////////////////////////////
...
/** @brief destructor */
    ...
    int InputSocket::getPacket(lslidar_ch128x1_msgs::LslidarChPacketPtr &packet) {
    ...
    int InputPCAP::getPacket(lslidar_ch128x1_msgs::LslidarChPacketPtr &pkt) {
