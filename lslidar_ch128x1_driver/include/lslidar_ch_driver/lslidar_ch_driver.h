...
#include <lslidar_ch128x1_msgs/LslidarChScanUnified.h>
...
public:
    ...
    void getFPGA_GPSTimeStamp(lslidar_ch128x1_msgs::LslidarChPacketPtr &packet);
...
private:
    ...
    bool createRosIO();
    bool openUDPPort();
    int getPacket(lslidar_ch128x1_msgs::LslidarChPacketPtr& msg);
